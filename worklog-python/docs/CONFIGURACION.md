...
`io.github.peperina.WorklogCalendarPy` (ruta
`/io/github/peperina/WorklogCalendarPy/`). Se edita desde la ventana de
...
```bash
# Ver un valor
gsettings get io.github.peperina.WorklogCalendarPy jira-site
# Cambiarlo
gsettings set io.github.peperina.WorklogCalendarPy view-mode '24h'
```
...
```bash
gsettings reset-recursively io.github.peperina.WorklogCalendarPy
```
